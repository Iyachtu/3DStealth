...
public enum PatrolState { Spotting, Looking, Following, Running}
...
public class PatrollingEnemyBehavior : MonoBehaviour
{
    ...
    [SerializeField] private float _WPdistanceTolerance;
    ...
    //2 states
    // patrouille
    // a vu / détecté le joueur, va vers le joueur
    //si le garde en vue x seconde -> alarm
